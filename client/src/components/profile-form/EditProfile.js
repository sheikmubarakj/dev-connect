...
import {createProfile,loadUserProfile} from "../../actions/profile";
...
const EditProfile = ({ createProfile,loadUserProfile,history,profile:{profile,loading} }) => {
    ...
    useEffect(() => {
      ...
      }, [loading, loadUserProfile, profile]);
  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={e => onSubmit(e)}>
        ...
        <div className="my-2">
          <button type="button" onClick={() => setSocialInputs(!displaySocialInputs)} className="btn btn-light">
...
export default connect(mapStateToProps,{createProfile,loadUserProfile})(withRouter(EditProfile))
